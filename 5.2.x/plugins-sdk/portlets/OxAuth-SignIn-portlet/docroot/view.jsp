...
<HTML>
    ...
    <BODY>
        ...
        if(myname!=null)
            {
             out.println("You are signed in as : <b> " +myname + "</b>");
            }
        else 
            {
            %>
            <form name="frmLogin" id="frmLogin" Method="POST" action="/OxAuth-SignIn-portlet/oxCheckLogin/" onSubmit="return validateForm()">
                <table>
                    <tr>
                        <td><b>Username  </b></td><td> <input name="username" size=15 type="text"  id="username" /> </td> 
                    </tr>
                    <tr>
                        <td><b>Password  </b></td><td> <input name="password" size=15 type="password" id="password" /> </td> 
                    </tr>
                </table>
                <br>
                <br>
